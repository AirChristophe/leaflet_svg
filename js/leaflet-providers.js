	...
	L.TileLayer.Provider.providers = {
		...
		MapBox: {
			...
			options: {
				...
				subdomains: 'abcd',
				id: 'streets',
				accessToken: 'pk.eyJ1IjoiY2hyaXN0b3BoZWR1dmFsIiwiYSI6ImNqajdhaGxmMTAzODkzcG52Ymw3NGRvMTMifQ.TS3oa1UK6-p0vNjlIFn4vA',
			}
		},
		Stamen: {
		...
		,
		Blue: {
			url: 'http://dev-test-player.georacing.com/resources/images/blue_tile.png',		
			options: {
							attribution: 'CD',
		...
		Test: {
			url: 'http://tileserver.georacing.com/data/ile-de-france/{z}/{x}/{y}.png',		
			options: {
							attribution: 'TEST',
